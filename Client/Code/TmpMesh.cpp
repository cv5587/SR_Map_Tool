...
void CTmpMesh::LateUpdate_GameObject()
{
...
HRESULT CTmpMesh::Add_Component()
{
	...
	pComponent = m_pMeshCom = dynamic_cast<CMesh*>(Engine::Clone_Proto(L"Proto_MeshTest"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
	m_mapComponent[ID_STATIC].insert({ L"Proto_MeshTest", pComponent });
